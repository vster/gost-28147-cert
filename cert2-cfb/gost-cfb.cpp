...
void main(void)
{
	...
	// Must be
	// d6 f0 a9 5a 28 a5 fc 57
	// c4 df 8c c1 84 62 6c 1a
	
	// Run test with KZU2
	cout << "\nTEST 2\n"; 
	cfb_run2test(g1, to1, s1, kzu2);
	// Must be
	// 55 08 c3 a5 3b 6a 55 ec
	// 8e a7 0d 76 21 72 f1 24

	// Run test with KZU3
	cout << "\nTEST 3\n"; 
	cfb_run2test(g1, to1, s1, kzu3);
	// Must be
	// 0f 11 c4 24 68 15 71 3d
	// c2 00 3b e0 b3 a2 2b e2

	// Run test with KZU4
	cout << "\nTEST 4\n"; 
	cfb_run2test(g1, to1, s1, kzu4);
	// Must be
	// 25 a6 78 89 65 5f 02 f8
	// 79 fb e2 2f 7c 21 35 0b

	// Run test with KZU5
	cout << "\nTEST 5\n"; 
	cfb_run2test(g1, to1, s1, kzu5);
	// Must be
	// 4b 64 bd 10 43 22 4c 3b
	// 0f aa 6c d9 55 48 eb 99
