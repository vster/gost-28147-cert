...
// S-блоки от Голлард Контейнер

{
{ 0xe,0x8,0x2,0x0,0xd,0x5,0x7,0x4,0x6,0xb,0x9,0xc,0x1,0xf,0x3,0xa },   	//1
{ 0x2,0xd,0x9,0xe,0xa,0x8,0x1,0x7,0x3,0xf,0x5,0xb,0xc,0x6,0x4,0x0 },   	//2
{ 0x6,0x4,0x9,0x7,0xb,0xa,0xf,0xc,0xd,0x5,0x1,0x8,0x2,0xe,0x3,0x0 },   	//3
{ 0x2,0x8,0x0,0x4,0xb,0x1,0xe,0xc,0x7,0x5,0x6,0xd,0xa,0x3,0x9,0xf },   	//4
{ 0xe,0x8,0x2,0xa,0xd,0x7,0x5,0x6,0x4,0x3,0x1,0xc,0x9,0xb,0x0,0xf },   	//5
{ 0x4,0xf,0x8,0x6,0xb,0x9,0xe,0x3,0x2,0xa,0x5,0x1,0xd,0x7,0xc,0x0 },   	//6
{ 0x9,0x7,0xb,0x4,0xf,0x6,0xe,0x5,0x8,0x1,0x2,0x3,0xc,0xa,0x0,0xd },   	//7
{ 0xc,0xf,0xb,0x3,0x8,0x2,0x9,0xd,0xa,0x4,0x6,0x7,0x0,0x1,0x5,0xe }	   	//8
}
};	
...
void Encrypt16(const byte in[BS], byte out[BS] )
{
	...
	for ( u32bit i = 0; i < 4; i++ )
		out[i] = get_byte(3-i, N1); 
	for ( u32bit i = 0; i < 4; i++ )
		out[i+4] = get_byte(3-i, N2);
}
/*************************************************
* GOST Output OID                              *
*************************************************/
